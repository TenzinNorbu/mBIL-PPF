                    ...
                    <tr>
                        <td colspan="3" style="text-align:left;">
                            <p>
                                    ...
                                    Jnrl No: <b>{{ $chequeNo }}</b>,<b>{{ $colBankName }}</b> being the payment of
                                    <u><i>@if($registration_type == 'PF') Private Provident @else Gratuity Fund @endif</i></u>for the Month of <b>{{ $forTheMonth }}</b>,
                                    <b>{{ $forTheYear }}</b>.
