...
<div class="container" style="height: 994px; margin-top: -25px; margin-bottom: -25px; ">
    <div class="row" style="height: 329px;">
        <div style="height: 300px;">
            @for($i = 0; $i < 3; $i++)
                <hr class="dashhr">
                <table style="font-size: 13px; cellpadding:-2px; cellspacing:-2px; border: 1px">
                    <tr>
                        <td colspan="3" align="center">
                            <b class="dashline"></b>
                            <img src="{{ storage_path('images/bannerbile.jpg') }}" alt=""
                        ...
                        <td colspan="3" style="text-align:left;">
                            <p>
                                @if($colType == "Cash")
                                    ...
                                    <b>{{ $colType }}</b>
                                    dated: <b>{{ $collectionDate }}</b> being the payment of <u><i> Private Provident
                                            Fund</i></u> for the Month of <b>{{ $forTheMonth }}</b>,
                                    <b>{{ $forTheYear }}</b>.
                                @elseif($colType == "Cheque")
                                    ...
                                    Cheque No <b>{{ $chequeNo }}</b>,<b>{{ $colBankName }}</b> being the payment of
                                    <u><i> Private Provident Fund </i></u>for the Month of <b>{{ $forTheMonth }}</b>, <b>{{ $forTheYear }}</b>.
                                @endif
                            </p>
                        </td>
                    </tr>
