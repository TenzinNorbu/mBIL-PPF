...
<div>
    ...
    <table class="table-bordered">
        <thead>
        <tr>
            <th colspan="7" align="left" style="border:none;">SUMMARY REPORT</th>
        </tr>
        <tr>
            <th>Particulars</th>
        ...
        <tr>
            ...
            $opening_total = $opening_cont_employee + $opening_cont_employer +
                            $opening_cont_employee_interest + $opening_cont_employer_interest - $opening_refund_disbursed_amount;
            ?>
            <td>{{ number_format(($opening_cont_employee + $opening_cont_employer +
                            $opening_cont_employee_interest + $opening_cont_employer_interest - $opening_refund_disbursed_amount),2) }}</td>

        </tr>

        {{--Current Balance --}}
        <tr>
            <td>Current Opening Balance</td>
            ...
            <td>{{ number_format(($opening_current_cont_employee + $opening_current_cont_employer +
                    $opening_current_cont_employee_int + $opening_current_cont_employer_int - $current_opening_refund_disbursed_amount),2) }}</td>
        </tr>
        {{--Current Balance --}}
        ...
        <tr> 
            ...
            <td><strong>{{ number_format(($current_opening_refund_disbursed_amount),2) }}</strong></td>
            <?php
            $netPayableBalance = $opening_cont_employee + $opening_current_cont_employee + $opening_cont_employer + $opening_current_cont_employer +
                $opening_cont_employee_interest + $opening_current_cont_employee_int + $as_on_interest_accrued_employee + $opening_cont_employer_interest +
                $opening_current_cont_employer_int + $as_on_interest_accrued_employer - ($opening_refund_disbursed_amount + $current_opening_refund_disbursed_amount);
            ?>
    ...
    <table class="table-bordered">
        ...
        <tr>
            <th colspan="11" align="left" style="border:none; font-size: small">NET PAYABLE AS ON DATE : {{ $to_Date }}, &nbsp;
                Nu. {{ number_format($netPayableBalance,2) }}/-
            </th>
        </tr>
        <tr>
            <td colspan="11" style="border:none;">&nbsp;</td>
