...
<html lang="en">
<head>
    <title>PF REFUND REQUEST NOTE</title>
</head>
<body>
...
<div>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <th colspan="2" style="border: none;"><h3>PF REFUND REQUEST NOTE</h3></th>
        </tr>
        <tr>
        ...
        <tr style="border: none">
            <td  style="border: none;">
                <p style="text-align: justify">
                    ...
                    <br>
                    Subject: <b>Forwarding documents - PPF Refund </b> <br> <br>

                    Sir/Madam, <br><br>
                    We are forwarding here with the attached documents of PPF refund against PF account No.
                    ...
                    <br><br>
                    Therefore, kindly process the PPF refund request of {{ ESolution\DBEncryption\Encrypter::decrypt($companyName) }},
    ...
    <table class="table table-bordered" style="border-collapse: collapse; border: none;">
        ...
        <tr style="border: none">
            <th  style="border: none;" align="left">Process By</th>
            <th  style="border: none;">Verified By</th>
        </tr>
        <tr style="border: none">
            <td colspan="2"  style="border: none;">&nbsp;</td>
        </tr>
        ...
        <tr style="border: none">
          <!-- {{ $process_by_name }} -->
            <th  style="border: none;" align="left"><img src="app/public/signatures/{{ $user_sign_cid }}.png" alt="" height="100"></th>
            <th  style="border: none;">Head</th>
        </tr>
        <tr style="border: none">
            <th  style="border: none;" align="left">{{ $process_by_branch }}</th>
            <th  style="border: none;">{{ $process_by_branch }}</th>
        </tr>
        <tr style="border: none">
            <td colspan="2"  style="border: none;">&nbsp;</td>
        </tr>
