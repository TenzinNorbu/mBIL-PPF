...
<div>
    ...
    <table class="table table-bordered" style="border-collapse: collapse; border: none;">
        ...
        <tr>
            <th colspan="2" style="border: none;"><h2>GF REFUND APPROVAL NOTESHEET</h2></th>
        </tr>
        <tr>
    ...
    <table class="table table-bordered" style="border-collapse: collapse; border: none;">
        <tr style="border: none;">
            <td style="border: none;">
                <p style="text-align: justify">
                    ...
                    to refund the GF for <b>Dasho/Mr/Mrs. {{ ESolution\DBEncryption\Encrypter::decrypt($refund_data->employee_name) }}</b>, CID No. <b>{{ ESolution\DBEncryption\Encrypter::decrypt($refund_data->identification_no) }}</b>
                    under GF Account No. <b> {{ ESolution\DBEncryption\Encrypter::decrypt($refund_data->employee_id_no) }}</b> vide Reference No. <b>{{ $refund_ref_no }}</b> dated
        ...
        <tr style="border: none">
            <td style="border: none;">
                <p style="text-align: justify">
                    Therefore, we would like to seek an approval for the GF refund request of <b>{{ ESolution\DBEncryption\Encrypter::decrypt($refund_data->org_name) }}</b>,
                    amounting to Nu. {{ number_format($refund_data->refund_total_disbursed_amount,2) }}/- as described below :
                    <br> <br>
    ...
    <table class="table table-bordered" style="border-collapse: collapse; border: none;">
        ...
        <tr style="border: none;">
            ...
            <th style="border: none;" width="40%" align="left">Counter Verified by: Passang Waiba<br>(IT Department)</th>
        </tr>
        <tr style="border: none;"><td colspan="2"> &nbsp;</td></tr>
        <tr style="border: none;"><td colspan="2"> &nbsp;</td></tr>
        <tr style="border: none;"><td colspan="2"> &nbsp;</td></tr>
        <tr style="border: none;">
            <th style="border: none;" width="60%" align="left">Approved By: Kinzang Tshering<br>
                (Director Finance)</th>
        </tr>
    </table>
</div>
