...
<html>
<head>
    <title>PF REFUND PAYMENT VOUCHER</title>
</head>
<body>
<style type="text/css">
    table {
...
<div>
    ...
    <table class="table table-bordered" style="border-collapse: collapse;">
        ...
        <tr>
            <th colspan="2" style="border: none;"><h2>PF REFUND PAYMENT VOUCHER</h2></th>
        </tr>
        <tr>
        ...
        @foreach($refund_payment_requests as $refund_detail_data)
            ...
            @foreach($refundTransactionCategory as $refundTransaction)
                ...
                @if($refundTransaction == 'PfColRefundPayableAc')
                    ...
                    <?php
                    //PF Collection Refund Payable Acc
                    $particular_pfCollectionPayableAc = \App\Models\Accounttype::where('account_type_id', '=', 'A5C730C0-45DF-11EC-AAE3-1D943BCC8402')
                    ...
                    <tr>
                        <td style="border: 1px solid #111">PF Refund Payable</td>
                        <td style="border: 1px solid #111">{{ $companyAccountNumber }} [{{ $particular01_code }}]/{{ $particular01 }}
