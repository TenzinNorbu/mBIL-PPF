...
class MonthlyClosingController extends Controller
{
                                               ...
                                               $gross_os_balance_employee, $gross_os_balance_employer, $employeeName, $no_of_days)
    {
        ...
        $transaction_ref_no = date('YmdH') . random_int(000000, 999999);
                                                       ...
                                                       $getForTheYear, $interestAccruedEmployee, $interestAccruedEmployer, $employeeName)
    {
        ...
        $accountTransactionId = date('YmdH') . random_int(00000000, 99999999);
        ...
        $accountTransaction->account_voucher_narration = 'PF Closing interest accrued payable against employee account no: ' . $employeeId;
        ...
        $cheque_date = NULL;
        $col_bank_name = NULL;
        $voucher_number = 'CL/PF/' . date('Y') . '/' . $branch_code . '/SYS/' . $accountTransactionSerialNo;
                                                            ...
                                                            $interestAccruedEmployer, $employeeName)
    {
        ...
        foreach ($closing_category as $closing_data) {
            ...
            $genAccountTransactiondetailsId =  Carbon::now()->format('YmdH'). random_int(00000000, 99999999);
